                  ...
                  <form >
                    <Row>
                      <Col size={12} sm={6} className='px-1'>
                        ...
                        <h3>
                          Name <Badge bg='secondary'>R.Piratheep</Badge>
                        </h3>
                      </Col>
                      <Col size={12} sm={6} className='px-1'>
                        {/* <input
                        ...
                        /> */}
                        <h3>
                          Phone <Badge bg='secondary'>+94 766189364</Badge>
                        </h3>
                      </Col>
                      <Col size={12} sm={6} className='px-1'>
                        {/* <input
                      ...
                      {/* <Col size={12} sm={6} className='px-1'>
                        ...
                        />
                        <h3>
                          Address <Badge bg='secondary'>+94 766189364</Badge>
                        </h3>
                      </Col> */}
